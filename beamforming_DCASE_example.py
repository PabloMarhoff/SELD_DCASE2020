...
from wavimport import WavSamples, SphericalGrid
from numpy import argmax,amax,pi,arange,arctan2,sin,cos
...
# Anzahl Stützstellen für Beamforming
NPOINTS = 400
...
def cart2spherical(x,y,z):
    return array([
        ...
        math.acos(z/(math.sqrt(x**2+y**2+z**2))) * 180/math.pi
    ])
...
#
rg = SphericalGrid(npoints=NPOINTS)
...
Lm = L_p(next(gen)).reshape(rg.shape) # get first block from generator pipeline
